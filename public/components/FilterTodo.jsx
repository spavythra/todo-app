    ...
    return (<>
        ...
        <ul className="filters">
                <li><a className={filter(index) === null ? 'selected' : null}
                       onClick={() => setFilter({filter: null, index})}>All</a></li>
                <li><a className={filter(index) === false ? 'selected' : null} onClick={() => setFilter({filter: false, index})}>Pending</a></li>
                <li><a className={filter(index) === true ? 'selected' : null}
                       onClick={() => setFilter({filter: true, index})}>Completed</a></li>
            </ul>}
    </>);
}
